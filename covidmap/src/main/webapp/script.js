function getNews() {
    ...
    async function newsFetch(e) {
        ...
        document.getElementById("location-info").innerHTML =("<br><br> <p>Please click a marker to get information about a specific testing center.<p>");
    }
}
...
function initMap() {
  ...
  addTestingCenters("");
  document.getElementById("location-info").innerHTML =("<br><br> <p>Welcome to COVAID.<p> <br> <p>Please enter your location above to obtain more accurate results and click a marker to get information about a specific testing center.<p>");
...
function setTestingCenterMarker(testingCenter, service) {
    ...
    service.getDetails(request, function(place, status) {
        if (status === google.maps.places.PlacesServiceStatus.OK) {
            ...
            testSiteInfo = ("<br><br><strong>" + place.name + "</strong><br>" + 
    ...
    var MarkerClickHandler = function() {
        ...
        var outputText = "<br><br><strong>" + this.title + "</strong><br>" + this.formatted_address + "<br>";
        // display info
        if (testSiteInfo) {
            document.getElementById("location-info").innerHTML = (testSiteInfo);
        }
